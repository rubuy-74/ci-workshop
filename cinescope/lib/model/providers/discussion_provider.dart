...
class DiscussionProvider extends ChangeNotifier {
  ...
  UnmodifiableSetView<Discussion> get userDiscussions =>
      UnmodifiableSetView(_userDiscussions);
  ...
  Future<UnmodifiableSetView<Discussion>> getDiscussionsByFilmId(
      String filmId) async {
    final queryData = await _storeInstance
  ...
  Future<void> addCommentToDiscussion(
      Discussion discussion, Comment newComment) async {
